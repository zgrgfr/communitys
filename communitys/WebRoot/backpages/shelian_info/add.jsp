                ...
                <div class="row">
                     <div class="col-md-12">
                        <form class="form-horizontal form-border" id="form" action="/communitys/CommunityPresenceController" method="post">
                        	<input type="hidden" name="method" value="addCommunityPresence2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="demo-test-date demo-test-datetime demo-test-time demo-test-credit com" name="time" required="" id="tests">
                                </div>
                            </div>
