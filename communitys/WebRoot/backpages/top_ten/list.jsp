                                    ...
                                    <tbody id="datalist">
                                        ...
                                        <c:forEach items="${communityShowDtoList}" var="communityShowDto">
                                        	<tr>
	                                        	...
	                                        	<td class="logoimg"><img src="backpages/image/${communityShowDto.communityShow.logo}"></td>
	                                            ...
	                                            <td>
                                                    <a href="/communitys/CommunityController?method=updateTopTen&topTen=0&id=${communityShowDto.community.id}" class="btn btn-default btn-sm" onclick="return confirm('确认删除？')">删除</a>
	                                            </td>
                                       		</tr>
                                        </c:forEach>
                                    </tbody>
