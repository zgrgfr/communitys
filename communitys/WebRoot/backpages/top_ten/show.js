			...
			success: function(data){
				...
				if(data == '[{"communityShowId":"0","logo":"","name":""}]'){
					...
					$.each(data1, function (index, item) {  
	 					//循环获取数据
						list += "<li><div class='img-box'><img src='/communitys/backpages/image/"+item.logo+"'></div><p class='img-cap deng' id='"+item.communityId+"'>"+item.name+"</p></li>";
            		...
            		// 十佳社团分配
			            ...
			            $("#sub").click(function () {
			                ...
			                $.ajax({
			                    type: "get",
			                    url: "/communitys/CommunityController?method=updateTopTen",
			                    data: {
			                        topTen:1,
			                        id:id
			                    },
