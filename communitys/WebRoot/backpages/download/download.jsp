                                ...
                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody id="datalist">
                                        ...
                                        <c:forEach items="${datumDownloadList}" var="datumDownload">
                                        	<tr>
												<td>${datumDownload.title}</td> 
												<td>${datumDownload.uploadName}</td>
												<td>
													<a href="backpages/file/${datumDownload.path}">${datumDownload.path}</a>
												</td>
	                                            <td>
	                                            	<a href="/communitys/DatumDownloadController?method=deleteById&id=${datumDownload.id}" class="btn btn-default btn-sm" onclick="return confirm('确认删除？')">删除</a>
	                                            </td>   
	                                        </tr>                                     	
                                        </c:forEach>
