                     ...
                     <div class="col-md-12">
                        <form class="form-horizontal form-border" id="form" action="/communitys/CommunityPresenceController" method="post">
                            ...
                            <div class="form-group">
                               ...
                               <div class="col-sm-6">
                               		<c:if test="${communityPresence.articleType eq '社团风采'}">
                                    ...
                                    <c:if test="${communityPresence.articleType eq '社团动态'}">
                               			<label class="radio-inline"><input class="icheck" type="radio" name="articleType" value="社团风采">社团风采</label>
                                    	<label class="radio-inline"><input class="icheck" type="radio" checked name="articleType" value="社团动态">社团动态</label>
                               		</c:if>
                                </div>
                            </div>
                             <div class="form-group">
