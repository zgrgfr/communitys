...
<body>
        <!--main content start-->
                ...
                <div class="row">
                     <div class="col-md-12">
                        <form class="form-horizontal form-border" id="form" action="/communitys/ClassController" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="demo-test-date demo-test-datetime demo-test-time demo-test-credit com" name="startTime" required="" id="tests">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">结束时间</label>
                                <div class="col-sm-6">
                                    <input type="text" class="demo-test-date demo-test-datetime demo-test-time demo-test-credit com" name="endTime"  required="" id="test">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <textarea id="textarea1" name="introduce" type="text/plain" style="height:350px;"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">内容</label>
                                <div class="col-sm-6">
                                    <textarea id="textarea2" name="content" type="text/plain" style="height:350px;"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
