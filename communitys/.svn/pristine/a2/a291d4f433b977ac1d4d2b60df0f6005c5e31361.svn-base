...
<body>
	...
	<div class="page clearfix">
		<div class="sidebar">
			<a href="/communitys/CommunityPresenceController?method=listByTypeAndArticleType&articleType=社团风采"><p class="select-select">社团风采</p></a>
		...
		<div class="main-content">
			...
			<div class="content-list">
				...
				<c:forEach items="${communityPresenceList }" var="communityPresence">
					<a href="/communitys/CommunityPresenceController?method=detailsView2&id=${communityPresence.id}">
						<li class="clearfix">
