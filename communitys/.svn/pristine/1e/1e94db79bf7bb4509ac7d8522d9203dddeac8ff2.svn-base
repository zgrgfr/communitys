...
<body>
	...
	<div class="page clearfix">
		...
		${msg}
			<form class="apply-from" action="/communitys/ActivityApplyController" method="post">
			...
			<div class="one">
				...
				<p>
					<label>活动发起者</label>
					<input type="text" class="text txt2" name="holder">
				</p>
				<p>
					<label>活动日期</label>
					<input type="text" class="text txt3" name="time" id="date">
				</p>
				<p>
					<label>活动开始时间</label>
					<input type="text" class="text txt4" name="timeStart" id="time">
				</p>
			</div>
				<div>
