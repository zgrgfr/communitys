                        ...
                        <form class="form-horizontal form-border" id="form" action="/communitys/SocialProgramsController" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <span class="timehidden" >${socialPrograms.activityTime}</span>
                                    <input type="hidden" name="activityTime" value="${socialPrograms.activityTime}" id="timehidden" />
                                </div>
                            </div>
                            <div class="settings" style="display:none;">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                   <textarea id="textarea1" name="activityContent" type="text/plain" style="height:350px;">${socialPrograms.activityContent}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">赞助内容</label>
                                <div class="col-sm-6">
                                    <textarea id="textarea2" name="supportContent" type="text/plain" style="height:350px;">${socialPrograms.supportContent}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
