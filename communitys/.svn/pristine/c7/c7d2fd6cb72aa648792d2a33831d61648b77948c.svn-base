                     ...
                     <div class="col-md-12">
                        <form class="form-horizontal form-border" id="form" method="post">>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <p class="form-control">${activityApply.name}</p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">申请人</label>
                                <div class="col-sm-6">
                                    <p class="form-control">${activityApply.holder}</p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">活动日期</label>
                                <div class="col-sm-6">
                                    <p class="form-control">${activityApply.time}</p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">活动开始时间</label>
                                <div class="col-sm-6">
                                    <p class="form-control">${activityApply.timeStart}</p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">活动内容</label>
                                <div class="col-sm-6">
                                    <p>${activityApply.content}</p>
                                </div>
                            </div>
                         </form>  
                    </div>
