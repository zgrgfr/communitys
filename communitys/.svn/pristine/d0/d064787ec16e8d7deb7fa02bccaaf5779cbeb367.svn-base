                                    ...
                                    <tbody id="datalist">
                                    	<c:forEach items="${socialProgramsList}" var="socialPrograms" >
	                                    	<tr>
	                                            ...
	                                            <td>
	                                                <a href="/communitys/SocialProgramsController?method=deleteById&id=${socialPrograms.id}" class="btn btn-default btn-sm" onclick="return confirm('确认删除？')">删除</a>
	                                            	...
	                                            	<c:if test="${sessionScope.account.role eq '超级管理员'}">
	 													<a href="/communitys/SocialProgramsController?method=passOrNotPass&id=${socialPrograms.id}&type=审核通过" class="btn btn-info btn-sm" onclick="return confirm('确认审核通过？')">审核通过</a>
	                                                	<a href="/communitys/SocialProgramsController?method=passOrNotPass&id=${socialPrograms.id}&type=审核不通过" class="btn btn-danger btn-sm" onclick="return confirm('确认审核不通过？')">审核不通过</a>
 													</c:if>
	                                            </td>
	                                        </tr>
                                    	</c:forEach>
