...
public class CommunityService {
	 ...
	 * @throws Exception
	 */
	public List<CommunityShowDto> queryByTopTen(int topTen) throws Exception{
		List<CommunityShowDto> communityShowDtoList = new ArrayList<CommunityShowDto>();
		List<Community> communityList	= communityDao.queryByTopTen(topTen);
		for(Community community : communityList){
			CommunityShowDto communityShowDto = new CommunityShowDto();
			CommunityShow communityShow = communityShowService.queryByCommunityId(community.getId());
			if(communityShow != null){
